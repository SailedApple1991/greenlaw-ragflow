...
# --- fork: doc_upload_and_parse (used by document_app /v1 + chat upload); LLMBundle calls adapted to v0.26 ---
def doc_upload_and_parse(conversation_id, file_objs, user_id):
    ...
    _embd_cfg = get_model_config_from_provider_instance(kb.tenant_id, LLMType.EMBEDDING, kb.embd_id)
    embd_mdl = LLMBundle(kb.tenant_id, _embd_cfg, lang=kb.language)
    ...
    _chat_cfg = get_tenant_default_model_by_type(kb.tenant_id, LLMType.CHAT)
    llm_bdl = LLMBundle(kb.tenant_id, _chat_cfg)
