...
# --- fork custom endpoints: knowledge_graph / graphrag / raptor / auto_metadata(compat) ---
...
@login_required
@add_tenant_id_to_kwargs
def get_auto_metadata_compat(tenant_id, dataset_id):
    """
    Get auto-metadata configuration for a dataset.
    ---
    tags:
...
@login_required
@add_tenant_id_to_kwargs
async def update_auto_metadata_compat(tenant_id, dataset_id):
    """
    Update auto-metadata configuration for a dataset.
    ---
    tags:
